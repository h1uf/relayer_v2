...
type RelayMsgSender struct {
	...
	SendMessages func(context.Context, []provider.RelayerMessage, string, uint64) (*provider.RelayerTxResponse, bool, error)
}
...
func (r *RelayMsgs) send(
	...
	for i, msg := range msgs {
		...
		resp, success, err := s.SendMessages(batchCtx, batchMsgs, memo, 0)
		batchCtxCancel()
		if err != nil {
