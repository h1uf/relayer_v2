...
func (cc *PenumbraProvider) SendMessage(
	...
	memo string, gas uint64) (*provider.RelayerTxResponse, bool, error) {
...
func (cc *PenumbraProvider) SendMessages(ctx context.Context, msgs []provider.RelayerMessage, _memo string, gas uint64) (*provider.RelayerTxResponse, bool, error) {
...
func (cc *PenumbraProvider) SendMessagesToMempool(ctx context.Context, msgs []provider.RelayerMessage, memo string, gas uint64, asyncCtx context.Context, asyncCallback []func(*provider.RelayerTxResponse, error)) error {
